...
public class BlogController extends Object {
    ...
    @Override
    @GetMapping
public ResponseEntity<?> get(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        processRequest(request, response, "doGet");
    }

    @Override
    @PostMapping
public ResponseEntity<?> post(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
